...
USERNAME = environ.get("USERNAME", "TheInertGuy")  # ADMIN USERNAME

# Database Channel
CHANNELS = [
    int(ch) if id_pattern.search(ch) else ch
    for ch in environ.get("CHANNELS", "-1002627559408").split()
]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "-1002786322741"))
AUTH_REQ_CHANNEL = int(environ.get("AUTH_REQ_CHANNEL", "0"))
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002598950094"))
LOG_API_CHANNEL = int(environ.get("LOG_API_CHANNEL", "-1002598950094"))
...
COLLECTION_NAME = environ.get("COLLECTION_NAME", "inert")
...
MOVIE_GROUP_LINK = environ.get("MOVIE_GROUP_LINK", "Move_Download")

# Verification
IS_VERIFY = is_enabled("IS_VERIFY", True)
# ---------------------------------------------------------------
TUTORIAL = environ.get("TUTORIAL", "https://t.me/UniformHelp/1499/2096")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/UniformHelp/1499/2096")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/UniformHelp/1499/2096")
...
START_IMG = (
    environ.get(
        "START_IMG",
        "https://i.ibb.co/Z17wzGxB/photo-2025-10-29-15-37-57-7566669083383431184.jpg https://i.ibb.co/Z17wzGxB/photo-2025-10-29-15-37-57-7566669083383431184.jpg",
    )
).split()
FORCESUB_IMG = environ.get("FORCESUB_IMG", "https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg")
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/PSI.jpg")).split()
PAYPICS = (
    environ.get("PAYPICS", "https://i.ibb.co/hFjZ6CWD/photo-2025-08-10-02-24-51-7536777335068950548.jpg")
).split()
SUBSCRIPTION = environ.get(
    "SUBSCRIPTION", "https://i.ibb.co/S4YtGjkz/photo-2024-05-08-17-36-45-7566670049751072784.jpg"
)
REACTIONS = ["👀", "😱", "🔥", "😍", "🎉", "🥰", "😇", "⚡"]
